...
useEffect(() => {
    ...
    const DrawLine = () => {
        const hrStyle: CSSProperties = {
            ...
            width: isOnMobile ? '80vw' : '1px',
            backgroundColor: 'white',
            opacity: .3,
        }
        if (isOnMobile) {
            return (<hr style={{opacity: .3}}></hr>)
        }
        return (
        ...
        <Container maxWidth={'100%'}
            ...
            >
                    {/* <Stack direction='column' width='100%' gap={3} alignItems={'center'}>
                        ...
                        <Stack direction={isOnMobile ? 'column' : 'row'} width={'100%'} spacing={isOnMobile? 2 : 10} 
                            sx={{
                                mb: '50px',
                                alignItems: 'center',
                                justifyContent: 'center',
                            ...
                            <Box sx={{
                                ...
                                >
                                    ...
                                    <a href="www.singsing.net">www.singsing.net</a>
                                </Typography>
                                <br></br>
                                <Typography variant="body2"
                                    sx = {{
