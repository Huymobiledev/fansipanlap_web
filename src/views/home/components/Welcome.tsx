        ...
        return (
            <Box width='100%' alignContent={'center'} justifyContent={'center'} sx={{
                ...
                <Stack direction={'row'} m='auto' gap={.5} sx={{objectFit:'contain'}}>
                    <svg height={h} viewBox="0 0 153 131" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <svg height={h} viewBox="0 0 138 131" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <svg height={h} viewBox="0 0 122 131" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <svg height={h} viewBox="0 0 84 131" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        return (
            <Box width='100%' alignContent={'center'} justifyContent={'center'} sx={{
                ...
                <Stack direction={'row'} m='auto' gap={.5}>
                    <svg height={h} viewBox="0 0 85 131" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <svg height={h} viewBox="0 0 137 131" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <svg height={h} viewBox="0 0 103 134" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <svg height={h} viewBox="0 0 129 131" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                >
                    <Stack sx={{
                        ...
                        <Grid container justifyContent={'center'} alignItems={'center'}>
                            <Grid item xs={10} sm={4.2} sx={{mb:.5}}>
                                <MAKE/>
                            </Grid>
                            <Grid item xs={10} sm={4.2} sx={{mb:.5}}>
                                <EASY/>
